...
public class LunarSolarConverter {
    ...
    private final static String[] holiday = {
            "0101 假", "0124 假", "0125 假", "0126 假", "0127 假", "0128 假", "0129 假", "0130 假"
            , "0404 假", "0405 假", "0406 假"
            , "0501 假", "0502 假", "0503 假", "0504 假", "0505 假"
            , "0625 假", "0626 假", "0627 假"
            , "1001 假", "1002 假", "1003 假", "1004 假", "1005 假", "1006 假", "1007 假"
    };
     ...
     * @time 2020/1/17 10:41
     */
    public static String getHoliday(int month , int day) {
        String holiday = "";
        Matcher m;
        for (int i = 0; i < LunarSolarConverter.holiday.length; i++) {

            m = LunarSolarConverter.sFreg.matcher(LunarSolarConverter.holiday[i]);

            if (m.find()) {

                if (month == LunarSolarConverter.toInt(m.group(1)) && day == LunarSolarConverter.toInt(m.group(2))) {
