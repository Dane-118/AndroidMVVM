...
public class MonthLableView extends View {
     ...
     * 默认的周末选中的颜色
     */
    private int defaultLableWeekendTextColor = Color.parseColor("#FA5740");
    private int defaultLableTextColor = Color.parseColor("#868F95");
    ...
    public MonthLableView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        weekendTextColor =
            typedArray.getColor(R.styleable.MonthLableView_cl_lableWeekendTextColor, defaultLableWeekendTextColor);
