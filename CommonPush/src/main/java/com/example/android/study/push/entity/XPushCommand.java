...
public class XPushCommand implements Parcelable {
    ...
    public String getTypeText(int type) {
        switch (type) {
            case CommandType.TYPE_REGISTER:
                return "TYPE_REGISTER";
            case CommandType.TYPE_UNREGISTER:
                return "TYPE_UNREGISTER";
            case CommandType.TYPE_ADD_TAG:
                return "TYPE_ADD_TAG";
            case CommandType.TYPE_DEL_TAG:
                return "TYPE_DEL_TAG";
            case CommandType.TYPE_BIND_ALIAS:
                return "TYPE_BIND_ALIAS";
            case CommandType.TYPE_UNBIND_ALIAS:
                return "TYPE_UNBIND_ALIAS";
            case CommandType.TYPE_AND_OR_DEL_TAG:
    ...
    public String getTypeName(int type) {
        switch (type) {
            ...
            case CommandType.TYPE_DEL_TAG:
                return "删除标签";
            case CommandType.TYPE_GET_TAG:
                return "获取标签";
            case CommandType.TYPE_BIND_ALIAS:
                return "绑定别名";
            case CommandType.TYPE_UNBIND_ALIAS:
                return "解绑别名";
            case CommandType.TYPE_GET_ALIAS:
                return "获取别名";
            case CommandType.TYPE_AND_OR_DEL_TAG:
                return "添加或删除标签";
            default:
